...
contract `harness/AGENTS.md` — is operator-internal and **not in the OSS mirror**.
The only public harness surface is `harness/fixtures/`, the wire-protocol fixtures
