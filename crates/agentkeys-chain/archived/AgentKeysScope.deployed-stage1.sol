...
// ============================================================================
// ARCHIVED REFERENCE — DEPLOYED ON HEIMA MAINNET TODAY
//   address : 0xd44b375daefc65768f417d0f0125b68d5ba7df3b (chain 212013)
//   selectors: setScopeWithWebauthn(...) = 0x864ae93c
//             revokeScope(...,K11Assertion) = 0x6f37dd80
//   source  : commit 3408a14 (v2 stage-1, #89/#92), deployed 2026-05-19
//
// This is the LIVE contract. The active src/AgentKeysScope.sol is the #164
// ERC-4337 "thinned" rewrite (setScope, no inline K11) which is NOT yet
// deployed — it ships only with the coordinated 4337 master-account registry
// cutover (see that file header + docs/spec/deployed-contracts.md). Kept here
// so the on-chain bytecode has a matching, findable source until the redeploy.
// Do NOT edit; regenerate via: git show 3408a14:crates/agentkeys-chain/src/AgentKeysScope.sol
// ============================================================================
