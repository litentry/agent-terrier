#!/usr/bin/env bash
# scripts/utils/check-deployed-contracts-sync.sh — two cheap deterministic checks
...
#
#   bash scripts/utils/check-deployed-contracts-sync.sh            # default chain: heima
#   CHAIN=heima bash scripts/utils/check-deployed-contracts-sync.sh
set -euo pipefail
