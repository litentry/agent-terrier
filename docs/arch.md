...
| **D3** | **A private key lives only on the machine it identifies.** K10 generated on-device, K11 in the platform authenticator, K3 sealed in the TEE; no key transits or rests elsewhere. | §3, §4, §10.2 |
