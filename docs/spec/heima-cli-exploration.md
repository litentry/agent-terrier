...
> **ARCHIVED** — This was the initial exploration document (2026-04-07). All questions below have been resolved. See [`plans/ceo-plan.md`](plans/ceo-plan.md) for the v0 plan, and [`credential-backend-interface.md`](credential-backend-interface.md) for the trait spec.
