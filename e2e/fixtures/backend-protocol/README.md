...
[`scripts/utils/check-backend-fixture-drift.sh`](../../../scripts/utils/check-backend-fixture-drift.sh)
...
(annotated bodies match these files) in the `e2e-ci.yml` `rust-checks` job.
