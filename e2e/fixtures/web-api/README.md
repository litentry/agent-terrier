...
| React frontend — [`daemon.ts`](../../../apps/parent-control/lib/client/daemon.ts) `plantMemory` | `# @web-fixture` annotation → [`check-web-api-drift.sh`](../../../scripts/utils/check-web-api-drift.sh) |
| harness — [`suite-6-web-parity.sh`](../../suite-6-web-parity.sh) step 3 | `# @web-fixture` annotation → `check-web-api-drift.sh` |
